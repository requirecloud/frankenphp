...
|:--------------------------------|:----------------|:-----------|:----|
| ghcr.io/requirecloud/frankenphp | 1.10.1-php8.4   | 1.10.1     | 8.4 |
| ghcr.io/requirecloud/frankenphp | 1.10.1-php8.4.x | 1.10.1     | 8.4 |
| ghcr.io/requirecloud/frankenphp | 1.10.1-php8     | 1.10.1     | 8.5 |
| ghcr.io/requirecloud/frankenphp | 1.10.1-php8.5   | 1.10.1     | 8.5 |
| ghcr.io/requirecloud/frankenphp | 1.10.1-php8.5.x | 1.10.1     | 8.5 |
| ghcr.io/requirecloud/frankenphp | latest          | 1.10.1     | 8.5 |
...
FROM ghcr.io/requirecloud/frankenphp:1.10.1-php8.5 AS frankenphp_base
