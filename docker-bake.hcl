...
target "php-83" {
  ...
  contexts = {
    frankenphp_upstream = "docker-image://dunglas/frankenphp:1.6.2-php8.3.21"
  }
  tags = [
    "${REPO_BASE}:1.7.0-php8.3",
    "${REPO_BASE}:1.7.0-php8.3.21"
  ]
}
...
target "php-84" {
  ...
  contexts = {
    frankenphp_upstream = "docker-image://dunglas/frankenphp:1.7.0-php8.4.8"
  }
  tags = [
    "${REPO_BASE}:1.7.0-php8",
    "${REPO_BASE}:1.7.0-php8.4",
    "${REPO_BASE}:1.7.0-php8.4.8",
    "${REPO_BASE}:latest"
  ]
}
