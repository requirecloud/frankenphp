...
target "php-84" {
  ...
  contexts = {
    frankenphp_upstream = "docker-image://dunglas/frankenphp:1.11.1-php8.4.16"
  }
  tags = [
    "${REPO_BASE}:1.11.1-php8.4",
    "${REPO_BASE}:1.11.1-php8.4.16",
...
target "php-85" {
  ...
  contexts = {
    frankenphp_upstream = "docker-image://dunglas/frankenphp:1.11.1-php8.5.1"
  }
  tags = [
    "${REPO_BASE}:1.11.1-php8",
    "${REPO_BASE}:1.11.1-php8.5",
    "${REPO_BASE}:1.11.1-php8.5.1",
    "${REPO_BASE}:latest",
  ]
}
